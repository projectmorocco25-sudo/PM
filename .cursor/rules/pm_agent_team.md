...
- **Hassan (QA/Assurance Engineer)**: RLS regression tests, workflow tests, job idempotency tests, audit-evidence verification. **Approach**: Test comprehensively but efficiently. Catch issues early, not in production.
