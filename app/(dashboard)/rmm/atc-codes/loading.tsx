/**
 * Loading skeleton for ATC Codes list page (Task 1.1.2.29)
 * Wireframe: task-0.5.2.14-atc-codes-list.md — Loading state
 */

export default function AtcCodesListLoading() {
  return (
    <div className="space-y-6 animate-pulse">
      <div className="h-5 w-48 rounded bg-[#e5e7eb]" aria-hidden />
      <div className="flex justify-between gap-4">
        <div className="h-9 w-64 rounded bg-[#e5e7eb]" aria-hidden />
      </div>
      <div className="h-10 w-full max-w-md rounded bg-[#e5e7eb]" aria-hidden />
      <div className="flex flex-col gap-6 lg:flex-row">
        <div className="h-64 w-full rounded-lg border border-[#e5e7eb] bg-white p-4 lg:w-[240px]">
