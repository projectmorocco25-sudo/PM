 ...
 * Implements: Documentation — search, category filters, expandable sections, quick links.
 * No DB, no API.
 * Wireframe Link: docs/04-design/user-experience/wireframes/00-core-foundation/public-pages/task-0.5.1.40-documentation.md
 */
