-- Migration: create_rmm_registry_complete_rpc
-- Description: Registry workflow RPC - completion
-- Date: 2026-01-15
-- Author: Maya
-- Phase: 1.1.2
-- Task: 1.1.2.10
...
CREATE OR REPLACE FUNCTION rmm_complete_registry_update(
...
BEGIN
  ...
  VALUES (p_submission_id, 'registry', v_from, v_to, v_actor, 'complete', rmm_sanitize_text(p_comments, 2000));
