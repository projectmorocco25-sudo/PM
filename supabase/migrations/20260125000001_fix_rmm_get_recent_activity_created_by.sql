-- Migration: fix_rmm_get_recent_activity_created_by
-- Description: Fix rmm_get_recent_activity to remove references to non-existent created_by columns
-- Date: 2026-01-25
-- Task: Phase 1 - RMM Overview Page Fix
-- Author: Sami (Implementation Compliance Specialist)
-- Issue: companies, products, skus tables don't have created_by columns

BEGIN;

-- Drop and recreate the function with fixed queries
