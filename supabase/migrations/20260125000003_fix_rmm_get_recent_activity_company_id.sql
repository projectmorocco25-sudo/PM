-- Migration: fix_rmm_get_recent_activity_company_id
-- Description: Fix company_id filtering in rmm_get_recent_activity - registry_submissions doesn't have company_id column
-- Date: 2026-01-25
-- Task: Phase 1 - RMM Overview Page Fix
-- Author: Sami (Implementation Compliance Specialist)
-- Issue: registry_submissions table doesn't have company_id column, need to filter through entity relationships

BEGIN;

-- Drop and recreate the function with fixed company filtering
