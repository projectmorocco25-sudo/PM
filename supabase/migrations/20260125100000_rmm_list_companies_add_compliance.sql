-- Migration: rmm_list_companies_add_compliance
-- Description: Extend rmm_list_companies with compliance_status, violation_count, enforcement_count per company (Phase 2, Task 2.1)
-- Wireframe: task-0.5.2.2-companies-list.md - Compliance Status (Fatima's Requirement)
-- Derives from enforcement_actions: violations = executed fines/suspensions; under_review = pending; compliant = none
